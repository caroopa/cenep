                ...
                <div class="contenedor-contenido">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Dominaci&oacute;n y violencia en grupos de varones</li>
                        </ol>
                    </nav>
                    <div class="encabezado-separador">
                        <h1>Dominaci&oacute;n y violencia en grupos de varones hist&oacute;ricamente autosegregados que inician un proceso de feminizaci&oacute;n: el caso del Ej&eacute;rcito Argentino y la Prefectura Nacional Argentina</h1>
                    </div>
                    <div class="texto">
                        ...
                        <p><strong>Infesta Dom&iacute;nguez, G. (2005)</strong> &quot;Estudios sobre seguridad y g&eacute;nero&quot;. Guardacostas. Revista Oficial de la Prefectura Naval Argentina, 61(116): 16-21, abril.</p>
                        </td>
                    </div>
                </div>
            </div>
