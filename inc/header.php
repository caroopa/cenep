<div class="logo-container">
    <a href="/index.php"><img src="/img/logo.png" alt="Logo" class="img100"></a>
</div>
    ...
    <div class="container-nav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/institucional/autoridades.php">Autoridades</a>
                        <a class="dropdown-item" href="/institucional/equipo.php">Equipo administrativo y técnico</a>
                        <a class="dropdown-item" href="/institucional/historia.php">Historia del CENEP</a>
                    </div>
                </li>
            ...
            <!-- <form class="form-inline my-2 my-lg-0">
                <input class="search" type="search" placeholder="Buscar" aria-label="Search">
